                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Nama Lengkap </th><td> {{ $replacementclass->nama_lengkap }} </td>
                                    </tr>
                                    <tr>
                                        <th> Mata Kuliah </th><td> {{ $replacementclass->mata_kuliah }} </td>
                                    </tr>
                                    <tr>
                                        <th> Kelas </th><td> {{ $replacementclass->kelas }} </td>
                                    </tr>
                                    <tr>
                                        <th> Jadwal Kuliah </th><td> {{ $replacementclass->jadwal_kuliah }} </td>
                                    </tr>
                                    <tr>
                                        <th> Jam Kuliah </th><td> {{ $replacementclass->jam_kuliah }} </td>
                                    </tr>
                                    <tr>
                                        <th> Jadwal Replacement </th><td> {{ $replacementclass->tanggal_replacement }} </td>
                                    </tr>
                                    <tr>
                                        <th> Jam Replacement</th><td> {{ $replacementclass->jam_replacement }} </td>
                                    </tr>
                                    <tr>
                                        <th> Alasan </th><td> {{ $replacementclass->alasan }} </td>
                                    </tr>
